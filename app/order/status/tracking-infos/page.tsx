...
export default function TrackingInfoPage() {
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-black/50">
      <div className="bg-white rounded p-6 w-full max-w-md shadow-lg flex flex-col items-center gap-6">
        {/* RESTO LOGO */}
        <Image
          ...
          loading="eager"
        />
        <h2 className="text-3xl text-gray-700 mb-4">Tracking Infos</h2>
        <Trackingform />
      </div>
    </div>
  );
